...
export default function Estetica() {
  ...
  return (
    <div>
      <Cabecalho />
      <div className="container-estetica">
        <h1>Cuidamos da sua <br></br>estética facial e corporal!</h1>

        <label>Por meio de técnicas exclusivas, unindo ciência e arte, realçamos <br></br>o que há de menor em você com harmonia e naturalidade</label>
      </div>
      <div className="tipos-exames">
        <h1>Nossos Procedimentos</h1>
        <label>Mantenha a beleza em dia com valores que cabem no seu bolso!</label>
