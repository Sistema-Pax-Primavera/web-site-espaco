      ...
      <div className='forms-trabalho'>
        ...
        <div className='formulario-trab'>
          <div className='icones-form'>
            ...
            <label>Acess
              e o Solid Jobs, através do link abaixo, vejas as vagas disponíveis, preencha todos campos com as suas informações e nos envie seu currículo, temos uma equipe preparada para receber você!</label>
